...
import cn.zhengyua.openwindow.view.adapter.RelatedAdapter
import cn.zhengyua.openwindow.view.adapter.ReplyAdapter
import cn.zhengyua.openwindow.viewmodel.PlayVideoViewModel
...
class PlayVideoActivity : GSYBaseActivityDetail<StandardGSYVideoPlayer>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestWindowFeature(Window.FEATURE_NO_TITLE) //要写在setContentView()方法的前面，不然会报错
    ...
    private fun loadTop() {
        ...
        viewModel.relatedPathData.observe(this, Observer { result ->
            ...
            if (list !== null) {
                ...
                rv_reply_play_video.adapter?.notifyDataSetChanged()
